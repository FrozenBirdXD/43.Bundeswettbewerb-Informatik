...
with open('krocket/beispielaufgaben/krocket4.txt', 'r') as file:
    next(file)
    for line in file:
...
P1 = (6.14299999999999,182.9909999999977)
P2 = (92.69300000000004,226.22499999999985) 


m = (P2[1] - P1[1]) / (P2[0] - P1[0])

x_values = [P1[0], P2[0] + 10000]  # Extend the x value
